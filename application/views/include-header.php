    ...
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="<?= base_url('home'); ?>">
                <img alt="Task Hub" src="<?= !empty($data->full_logo) ? base_url('assets/icons/' . $data->full_logo) : base_url('assets/icons/logo.png'); ?>" width="200px" height="80px">
            </a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?= base_url('home'); ?>">
                <img alt="Task Hub" src="<?= !empty($data->half_logo) ? base_url('assets/icons/' . $data->half_logo) : base_url('assets/icons/logo-half.png'); ?>" width="40px" height="40px">
            </a>
        </div>
