      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1><?= !empty($this->lang->line('label_settings'))?$this->lang->line('label_settings'):'Settings'; ?> </a>
          </div>
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-6 col-md-9">
                              ...
                              <input type="text" name="email" class="form-control" id="email-set" value="<?= !empty($dataemail->email)?'EMAIL_ADDRESS':'EMAIL_ADDRESS' ?>" required>
                          ...
                          <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-6 col-md-9">
                              <input type="text" name="password" class="form-control" id="password" value="<?= !empty($dataemail->password)?'PASSWORD':'PASSWORD' ?>" required>
                          ...
                          <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-6 col-md-9">
                              <input type="text" name="smtp_host" class="form-control" id="smtp_host" value="<?= !empty($dataemail->smtp_host)?'SMTP_HOST':'SMTP_HOST' ?>" required>
                          ...
                          <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-6 col-md-9">
                              <input type="text" name="smtp_port" class="form-control" id="smtp_port" value="<?= !empty($dataemail->smtp_port)?'SMTP_PORT':'SMTP_PORT' ?>" required>
                      ...
                      <div class="card" id="system-settings-card">
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-6 col-md-9">
                              <input type="text" name="fcm_server_key" class="form-control" id="fcm_server_key" value="<?= !empty($datasystem->fcm_server_key)?'YOUR_FCM_SERVER_KEY':'YOUR_FCM_SERVER_KEY' ?>" required>
                            </div>
                          </div>
                          ...
                          <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-6 col-md-9">
                              ...
                              <input type="text" name="apiKey" class="form-control" id="apiKey" value="<?= !empty($datasystem->apiKey)?'YOUR_FCM_API_KEY':'YOUR_FCM_API_KEY'; ?>" required>
                            </div>
                          </div>
                          ...
                          <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-6 col-md-9">
                              <input type="text" name="projectId" class="form-control" id="projectId" value="<?= !empty($datasystem->projectId)?'YOUR_FCM_PROJECT_ID':'YOUR_FCM_PROJECT_ID' ?>" required>
                            </div>
                          </div>
                          ...
                          <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-6 col-md-9">
                              <input type="text" name="messagingSenderId" class="form-control" id="messagingSenderId" value="<?= !empty($datasystem->messagingSenderId)?'YOUR_FCM_SENDER_ID':'YOUR_FCM_SENDER_ID' ?>" required>
                            </div>
                          </div>
